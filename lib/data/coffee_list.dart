...
List<CoffeeClass> allcoffee = [
  ...
  CoffeeClass(
      ...
      price: 10,
      berif:
          "Espresso is a concentrated form of coffee produced by forcing hot water under high pressure through finely-ground coffee beans. Originating in Italy, espresso has become one of the most popular coffee-brewing methods worldwide. ",
      rating: 2,
      quantity: 1),
  CoffeeClass(
      image: "assets/images/tea4.jpg",
      name: "Latte",
      price: 5,
      berif:
      ...
      quantity: 1),
  CoffeeClass(
      image: "assets/images/tea5.jpg",
      name: "Flat white",
      price: 11,
      berif:
          "A flat white is a coffee drink consisting of espresso and steamed milk. It generally has a higher proportion of espresso to milk than a caffè latte, and lacks the thick layer of foam in a cappuccino.",
      rating: 4,
      quantity: 1),
  CoffeeClass(
      image: "assets/images/tea6.jpg",
      name: "Affogato",
      price: 10,
      berif:
          "Affogato, known in full in Italian as affogato al caffè, is an Italian dessert comprising a scoop of plain milk-flavored or vanilla gelato or ice cream topped with hot espresso. Some variations add a shot of amaretto, bicerin, Kahlúa, or other liqueur.",
      rating: 5,
      quantity: 1),
  CoffeeClass(
      image: "assets/images/tea7.jpg",
      name: "Cortado",
      price: 8,
      berif:
