...
import 'package:coffee_app/model/card_model.dart';
import 'package:coffee_app/model/coffee_class.dart';
import 'package:coffee_app/pages/order_page.dart';
          ...
          child: Column(
            ...
            children: [
                  ...
                  Row(
                    children: [
                      Container(
                          ...
                          child: Image(
                            image: AssetImage("assets/images/deli.jpg"),
                            fit: BoxFit.cover,
                          )),
                      Gap(10),
                      Container(
                          ...
                          child: Image(
                            image: AssetImage("assets/images/bean.jpg"),
                            fit: BoxFit.cover,
                          )),
                      Gap(10),
                      Container(
                          ...
                          child: Image(
                            image: AssetImage("assets/image/cupo.jpg"),
                            fit: BoxFit.cover,
                          )),
                    ],
                  ),
              ...
              Row(
                ...
                children: [
                  _buildSizeButton("Sml"),
                  _buildSizeButton("Med"),
                  _buildSizeButton("Lrg"),
                ],
              ),
              SizedBox(height: 20),
              Row(
