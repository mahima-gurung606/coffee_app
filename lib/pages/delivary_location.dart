...
class _DeliveryTrackingScreenState extends State<DeliveryTrackingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [Icon(Icons.settings), Gap(10)],
      ),
      body: Stack(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/image/coffee_location.jpg'),
                    fit: BoxFit.cover)),
          ),
          Positioned(
            bottom: 0,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: myStyle(14, Colors.grey, FontWeight.bold),
                  ),
                  Gap(20),
                  Row(
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        image: DecorationImage(
                          image: AssetImage("assets/images/aria.jpg"),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
