import 'package:coffee_app/controller/home%20controller.dart';
import 'package:coffee_app/data/coffee_list.dart';
import 'package:coffee_app/data/name_list.dart';
                                  ...
                                  Stack(clipBehavior: Clip.none, children: [
                                    Container(
                                      ...
                                      width: MediaQuery.of(context).size.width *
                                          0.4,
                                      decoration: BoxDecoration(color: three),
                                    ),
                                    Positioned(
                                      top: -10,
                                      right: 5,
                    ...
                    itemBuilder: (context, index) {
                      return Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Get.to(CoffeeDetailPage(
                                coffee: allcoffee[index],
                              ));
                            },
                            child: Card(
                              color: Colors.white,
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: AssetImage(
                                              "${homeController.filteredData[index].image}"),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      child: Row(
